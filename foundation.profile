...
function foundation_profile_details() {
  return array(
    'name' => 'Foundation Install Profile',
    'description' => 'Select this profile to enable some basic modules in addition to core.'
  );
}
 ...
 *   task list.
 */
function foundation_profile_task_list() {
}
...
function foundation_form_alter(&$form, $form_state, $form_id) {
  if ($form_id == 'install_configure') {
    ...
    $form['site_information']['site_name']['#foundation_value'] = $_SERVER['SERVER_NAME'];
  }
}
